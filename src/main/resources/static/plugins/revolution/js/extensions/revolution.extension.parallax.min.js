        ...
        checkForParallax: function (a, e) {
            ...
            if (!f.done) {
                ...
                "mouse" != f.type && "scroll+mouse" != f.type && "mouse+scroll" != f.type && "3D" != f.type && "3d" != f.type || (a.mouseenter(function (b) {
                    var c = a.find(".active-revslide"), d = a.offset().top,
                        e = a.offset().left, f = b.pageX - e, g = b.pageY - d;
                    ...
                    if ("enterpoint" == f.origo) {
                        ...
                        var i = d.data("enterx") || b.pageX - h,
                            ...
                            k = i - (b.pageX - h), l = j - (b.pageY - g),
                            m = f.speed / 1e3 || .4
                    } else var g = a.offset().top, h = a.offset().left,
                    ...
                    var i = a.width(), j = a.height(), k = 360 / i * d,
                        l = 180 / j * c, m = f.speed / 1e3 || 3, n = [];
            ...
            var f = a.c[0].getBoundingClientRect(), g = a.viewPort,
                h = a.parallax,
            ...
            if ("3d" != h.type && "3D" != h.type) {
                ...
                if (h.bgcontainers) for (var k = 0; k < h.bgcontainers.length; k++) {
                    var o = h.bgcontainers[k], p = h.bgcontainer_depths[k],
                        n = i * -(p * a.conh) || 0;
